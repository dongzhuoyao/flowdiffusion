...
def fvd2048_16f(opts):
    ...
    fvd = frechet_video_distance.compute_fvd(
        opts, max_real=2048, num_gen=2048, num_frames=16
    )
...
def fvd2048_128f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(
        opts, max_real=2048, num_gen=2048, num_frames=128
    )
...
def fvd2048_128f_subsample8f(opts):
    ...
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(
        opts, max_real=2048, num_gen=2048, num_frames=16, subsample_factor=8
    )
...
def isv2048_ucf(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    mean, std = video_inception_score.compute_isv(
        opts, num_gen=2048, num_splits=10, backbone="c3d_ucf101"
    )
