...
# https://github.com/bytedance/1d-tokenizer/blob/c6ead5127bf80eccf40fc1525c6646310ef4d3dc/data/convert_imagenet_to_wds.py#L2
import argparse
import os
import sys
import time
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="./data/imagenet256_raw_varysize",
...
mkdir -p ./data/imagenet_rawvarysize_wds
python datasets_wds/make_wds_imagenet256_raw_varysize.py --output_dir ./data/imagenet256_raw_varysize
"""
