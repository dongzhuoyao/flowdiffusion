    ...
    def __init__(
        ...
        **kwargs,  #
        ...
        train_processing_pipeline = build_train_processing_pipeline(
            transform, num_classes=num_classes, crop_size=crop_size, use_latent=use_latent,save_image=save_image,save_dino=save_dino
        )
...
def build_train_processing_pipeline(transform, num_classes=0, crop_size=256, use_latent=False,save_image=0,save_dino=0):
    ...
    if save_dino:
        rename_map["dino_feature"] = "npy;dino_feature.npy"
...
if __name__ == "__main__":
    if False:
        dataloader = SimpleImageDataset(
            train_shards_path="./data/processed_faceshq_precomputed_latent/shard_{000000..000002}.tar",
            eval_shards_path="./data/processed_faceshq_precomputed_latent/shard_{000000..000002}.tar",
        ...
        dataloader = SimpleImageDataset(
            train_shards_path="./data/imagenet_1k_256x256_latents_img1/shard_{000000..000002}.tar",
            eval_shards_path="./data/imagenet_1k_256x256_latents_img1/shard_{000000..000002}.tar",
            num_train_examples=1000,
            per_gpu_batch_size=64,
            global_batch_size=64,
            num_workers_per_gpu=12,
