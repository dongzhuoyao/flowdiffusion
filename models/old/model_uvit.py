...
class UViT(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        if self.num_classes > 0:
            ...
            self.extras = 1 + 1
        elif self.num_classes == -666:  # use -666 to indicate using text embedding
            self.extras = 77 + 1
    ...
    def forward(self, x, timesteps, y=None):
        ...
        if self.num_classes > 0:
            ...
            text_embedding = self.context_embed(y)
...
if __name__ == "__main__":
    model = UViT(
        image_size=32, num_classes=-666, patch_size=2, embed_dim=1024, depth=48
    )
