...
class Attention(Attention_):
    def forward(self, x, HW=None, **kwargs):
        ...
        if True:
            #with torch.nn.attention.sdpa_kernel([torch.nn.attention.SDPBackend.MATH, torch.nn.attention.SDPBackend.FLASH_ATTENTION, torch.nn.attention.SDPBackend.EFFICIENT_ATTENTION]):
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.num_heads = num_heads
        use_shortcut = True #always use shortcut
